...
<h1 style="margin-top:-50px; margin-bottom:10px; margin-left:25px; font-family:Helvetica">Pegar Coordenadas</h1>
<hr />
    	...
    	<div class="row-fluid show-grid">
    		...
    		<div class="span9">
	        	...
	        	<div id="map-canvas" class="col50 f-right">
					<div align="center" id="map" style="width:500px; height:250px; margin-left:100px"></div>
				</div><!-- /map-canvas -->
     		</div>
